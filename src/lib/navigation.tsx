	...
	[
		{
			...
			text: 'Resume',
			href: 'https://drive.google.com/file/d/1uwq_Gzd5feve2BTY-K4wJqbMnyidmw21/view?usp=sharing',
			external: true,
		},
		{
			type: NavigationItemType.LINK,
			...
			text: 'Twitter',
			href: 'https://twitter.com/krishpranav5',
			external: true,
		},
		{
			type: NavigationItemType.LINK,
			icon: 'feather:github',
			text: 'GitHub',
			href: 'https://github.com/krishpranav',
			external: true,
		},
	],
];
