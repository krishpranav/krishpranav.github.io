export const navItems = [
  ...
  { name: "Resume", link: "https://drive.google.com/file/d/1RxQAZVmbbvU4SwOlws7GvXzeIYJHffJZ/view?usp=sharing" },
];
...
export const workExperience = [
  ...
  {
    id: 4,
    title: "Interviewer/Reviewer - Brototype",
    desc: "Conducted technical reviews to evaluate candidates' expertise in Flutter and Swift development, ensuring alignment with organizational standards. Reviewed coding assignments and project submissions, providing constructive feedback to improve code quality, adherence to best practices, and overall development skills.  Assessed problem-solving abilities and technical proficiency through in-depth discussions and coding challenges. Collaborated with the team to refine evaluation processes and criteria for better candidate assessment. Contributed to the identification of top-tier talent for development roles in a fast-paced, technology-driven environment.",
    timeline: "Nov 2024 - Present",
    techstack: "Techs Used: Flutter, Swift",
    className: "md:col-span-2",
  },
